...
<section id="main-content">
	<section class=" wrapper">
		...
		<u><h2 class="w3ls_head" style="color:red;">INSERT STUDENT DETAILS</h2></u>
            <div class="row">
                <div class="col-lg-12">
                 <p class="hd-title">ADD  STUDENT</p>
               </div>
                 <div class="col-lg-12">
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <form class="form-group" action="" method="POST" enctype="multipart/form-data"  >
                                ...
                                <input type="text" name="sname" class="form-control" placeholder="enter name"><br>
                                ...
                                <input type="text" name="class" class="form-control" placeholder="enter name"><br>

                                 MOBILE NUMBER:

                                <input type="text" name="mobile" class="form-control" placeholder="enter name" required=""><br>
